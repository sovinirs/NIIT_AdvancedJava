...
public class Branches extends HttpServlet {  
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session!=null){
            ...
            out.print("<html><br><b> Welcome to Branches page </b><br>");
    		DatabaseConnection db = new DatabaseConnection();
    		Connection conn = db.getConnection();
    		String SQL = "SELECT branchcode,branchlocation FROM branches";
    		Statement stmt = null;
			try {
    		...
    		try {
				...
				writer.println("<th> Location </th></tr>"); 
				while(rs.next()) 
				{ 
				writer.println("<tr><td>"+rs.getString("branchcode")+"</td>"); 
				writer.println("<td>"+rs.getString("branchlocation")+"</td></tr>"); 
				} 
